// ── ARCHITECTURE NOTE ───────────────────────────────────
//
// This file is the binary entry point. Almost all logic is in sibling
// modules:
//
...
//
// `main.rs` only owns the binary entry point, the `OnceLock` globals,
// module declarations, and re-exports of types other modules import as
// `crate::Foo`.
// ────────────────────────────────────────────────────────
