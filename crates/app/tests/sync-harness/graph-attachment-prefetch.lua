-- description: Graph sync triggers PrefetchRuntime; attachment bytes land in PackStore
-- expected: pass
...
-- kick, a Microsoft Graph account's attachments must also land in
-- PackStore by the time `prefetch.completed` fires.
...
local dir = harness.data_dir("sync_graph_attachment_prefetch")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "sync-graph-prefetch@example.test",
    display_name = "Sync Graph Prefetch",
    account_name = "Sync Graph Prefetch",
    provider = "graph",
})
