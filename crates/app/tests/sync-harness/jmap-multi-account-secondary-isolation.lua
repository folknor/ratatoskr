...
-- empty ids array, per notes/request-log.md). The "secondary delta must
...
-- present. A genuine state-isolation regression (secondary's
-- Email/changes wrongly reporting email-secondary-001 as updated) still
...
harness.assert_eq(
    count_email_hydrations(delta_requests, "account-secondary"),
    0,
...
harness.write_summary({
    ...
    email_get_secondary = count_email_hydrations(delta_requests, "account-secondary"),
})
