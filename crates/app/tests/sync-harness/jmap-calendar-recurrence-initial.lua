-- description: JMAP calendar initial sync imports recurrence rules from the small fixture
-- expected: pass
...
local dir = harness.data_dir("sync_jmap_calendar_recurrence_initial")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "sync-jmap-calendar-recurrence@example.test",
    display_name = "Sync JMAP Calendar Recurrence",
    account_name = "Sync JMAP Calendar Recurrence",
    provider = "jmap",
})
