-- description: JMAP initial sync imports a many-folder fixture
-- expected: pass
-- fixture: jmap-many-folders.lua
-- protocol: jmap
-- ceiling: 120s
...
local dir = harness.data_dir("sync_jmap_many_folders_initial")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "sync-jmap-many-folders@example.test",
    display_name = "Sync JMAP Many Folders",
    account_name = "Sync JMAP Many Folders",
    provider = "jmap",
})
