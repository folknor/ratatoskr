-- description: JMAP WebSocket push imports a new message without a second sync kick
...
local dir = harness.data_dir("sync_jmap_push_websocket")
...
local account, account_err = client:request("TestSeedAccount", {
    ...
    display_name = "JMAP Push",
    account_name = "JMAP Push",
    provider = "jmap",
})
...
harness.assert(
    ...
    "push reconcile did not call Email/changes"
)
