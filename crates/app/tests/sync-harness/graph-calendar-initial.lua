-- description: Graph calendar initial sync imports the small fixture
-- expected: pass
...
local account, account_err = client:request("TestSeedAccount", {
    email = "sync-graph-calendar@example.test",
    display_name = "Sync Graph Calendar",
    account_name = "Sync Graph Calendar",
    provider = "graph",
})
