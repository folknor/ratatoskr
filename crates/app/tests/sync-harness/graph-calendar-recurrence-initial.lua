-- description: Graph calendar initial sync imports recurrence rules from the small fixture
-- expected: pass
...
local dir = harness.data_dir("sync_graph_calendar_recurrence_initial")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "sync-graph-calendar-recurrence@example.test",
    display_name = "Sync Graph Calendar Recurrence",
    account_name = "Sync Graph Calendar Recurrence",
    provider = "graph",
})
...
harness.assert_eq(single.start_time, 1770732000, "single start_time")
harness.assert_eq(single.end_time, 1770735600, "single end_time")
