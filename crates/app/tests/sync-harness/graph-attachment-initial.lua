-- description: Graph initial sync imports attachment metadata from message payloads
-- expected: pass
...
local dir = harness.data_dir("sync_graph_attachment_initial")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "sync-graph-attachment@example.test",
    display_name = "Sync Graph Attachment",
    account_name = "Sync Graph Attachment",
    provider = "graph",
})
...
harness.assert(message_delta_requests >= 1, "Graph attachment sync did not fetch mail")
