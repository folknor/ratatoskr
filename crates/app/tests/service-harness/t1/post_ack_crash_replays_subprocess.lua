-- description: post-ack worker crash respawns and replays journaled plan
-- ceiling: 120s
...
local dir = harness.data_dir("t1_post_ack_crash_replays_subprocess")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "m4-post-ack@example.test",
...
harness.assert(crash_err == nil, "crash hook failed")
...
harness.assert(ack_err == nil, "action.execute_plan lost post-ack response")
