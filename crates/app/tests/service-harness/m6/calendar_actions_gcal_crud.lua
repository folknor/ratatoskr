...
local dir = harness.data_dir("m6_calendar_actions_gcal_crud")
...
local account, account_err = client:request("TestSeedAccount", {
    email = "m6-calendar-actions-gcal@example.test",
    display_name = "M6 Calendar Actions Google",
    account_name = "M6 Calendar Actions Google",
    provider = "gmail_api",
})
