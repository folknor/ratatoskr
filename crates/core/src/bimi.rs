...
// Re-export cache types and functions from db.
pub use crate::db::queries_extra::bimi::{BimiCacheEntry, get_bimi_cache, upsert_bimi_cache};
...
fn domains_to_warm(conn: &Connection) -> Result<Vec<String>, String> {
    crate::db::queries_extra::bimi::domains_to_warm(
        conn,
        WARM_LOOKBACK_DAYS,
        i64::from(WARM_MAX_MESSAGES),
    )
}
