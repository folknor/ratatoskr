...
pub struct Config {
    ...
    pub seed: u64,
    /// Total number of designated chat contacts to seed across all accounts.
    /// Each contact is round-robin-assigned to a single account and gets 1-3
    /// strictly-1:1 threads on that account. Set to 0 to disable.
    pub chats: u32,
}
