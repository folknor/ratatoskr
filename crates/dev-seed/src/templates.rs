...
fn body_templates(cat: Category) -> &'static [&'static str] {
    match cat {
        ...
        Category::Newsletter => &[
            "<div style=\"max-width:600px;margin:0 auto;font-family:sans-serif;\">\n<h1 style=\"color:#333;\">This Week in {topic}</h1>\n<p>Here's your weekly roundup of what's happening in the {topic} world.</p>\n<h2>Top Stories</h2>\n<ul>\n<li><strong>Major release:</strong> <a href=\"https://www.rust-lang.org/\">{service} v{v}.0 brings {topic} support</a></li>\n<li><strong>Industry news:</strong> <a href=\"https://example.com/news\">{candidate} joins {service} as CTO</a></li>\n<li><strong>Tutorial:</strong> <a href=\"https://example.com/tutorials/getting-started\">Getting started with {topic} in 2024</a></li>\n</ul>\n<hr>\n<p style=\"color:#999;font-size:12px;\">You're receiving this because you subscribed at {service}.com.\n<a href=\"https://example.com/unsubscribe\">Unsubscribe</a></p>\n</div>",
        ],
        Category::Commerce => &[
...
pub fn fill_template(template: &str, rng: &mut dyn RngMut, locale: Option<&LocaleData>) -> String {
    ...
    let order: String = order_bytes[..4]
        .iter()
        .map(|b| format!("{b:02X}"))
        .collect();
