...
- [ ] **Codebase contracts** — 17 remaining implicit contracts (5 fixed). See `docs/contracts/problem-statement.md` for the full catalogue with priorities, violation examples, and structural fix sketches.
