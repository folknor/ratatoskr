...
- [ ] **Codebase contracts** — 9 remaining implicit contracts (13 fixed). See `docs/contracts/problem-statement.md` for the full catalogue with priorities, violation examples, and structural fix sketches.
