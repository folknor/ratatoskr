...
- [ ] **Codebase contracts** — 14 remaining implicit contracts (8 fixed). See `docs/contracts/problem-statement.md` for the full catalogue with priorities, violation examples, and structural fix sketches.
