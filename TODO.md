...
- [ ] **Codebase contracts** — 12 remaining implicit contracts (10 fixed). See `docs/contracts/problem-statement.md` for the full catalogue with priorities, violation examples, and structural fix sketches.
