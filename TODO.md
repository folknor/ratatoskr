...
- [ ] **Codebase contracts** — 15 remaining implicit contracts (7 fixed). See `docs/contracts/problem-statement.md` for the full catalogue with priorities, violation examples, and structural fix sketches.
