...
- [ ] **Codebase contracts** — 13 remaining implicit contracts (9 fixed). See `docs/contracts/problem-statement.md` for the full catalogue with priorities, violation examples, and structural fix sketches.
