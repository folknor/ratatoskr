#!/usr/bin/env python3
"""Phase 3 task 2: rename `BodyStoreState` -> `BodyStoreReadState`
across the workspace. The renamed type keeps all its methods for the
moment; Phase 3 task 5 / 7 plumbs `BodyStoreWriteState` through the
sync provider contexts and removes the write methods from the read
state.
...
TARGETS = [
    ...
    "crates/db/src/db/queries_extra/message_queries.rs",
]

OLD = "BodyStoreState"
NEW = "BodyStoreReadState"
