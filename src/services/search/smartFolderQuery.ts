  ...
  return Promise.all(
    uniqueRows.map(async (r) => {
      ...
      return {
        ...
        isRead: dbThread ? Boolean(dbThread.is_read) : false,
        isStarred: dbThread ? Boolean(dbThread.is_starred) : false,
        isPinned: dbThread ? Boolean(dbThread.is_pinned) : false,
        isMuted: dbThread ? Boolean(dbThread.is_muted) : false,
        hasAttachments: dbThread ? Boolean(dbThread.has_attachments) : false,
        labelIds,
