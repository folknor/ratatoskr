...
export const MessageItem = memo(function MessageItem({
  ...
  onContextMenu,
  ref,
}: MessageItemProps & { ref?: RefObject<HTMLDivElement | null> }) {
  ...
  }, [isLast, loadAttachments]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [focused, expanded, loadAttachments]); // eslint-disable-line react-hooks/exhaustive-deps
