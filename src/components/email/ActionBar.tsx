      ...
      <div className="flex items-center gap-1 px-3 py-3 border-b border-border-secondary bg-bg-secondary">
        ...
        <Button
          ...
          icon={
            <Star
              size={15}
              className={thread.isStarred ? "fill-current" : ""}
            />
          }
        ...
        <Button
          ...
          icon={
            <VolumeX
              size={15}
              className={thread.isMuted ? "fill-current" : ""}
            />
          }
        ...
        <Button
          ...
          icon={
            <ListTodo
              size={15}
              className={taskSidebarVisible ? "text-accent" : ""}
            />
          }
        ...
        <Button
          ...
          title={
            contactSidebarVisible
              ? t("hideContactSidebar")
              : t("showContactSidebar")
          }
        />
      </div>
