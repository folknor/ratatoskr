...
export function Composer(): React.ReactNode {
  ...
  useEffect(() => {
    ...
    void Promise.all([
      ...
      // Templates
      templateShortcutsRef.current = templates.filter((tmpl) => tmpl.shortcut);
    });
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-border-primary bg-bg-secondary rounded-t-lg">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                type="button"
                onClick={() => void handlePopOutComposer()}
                className="text-text-tertiary hover:text-text-primary p-1 rounded transition-colors"
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {signatureHtml !== "" && (
              <div
                ...
                // biome-ignore lint/security/noDangerouslySetInnerHtml: sanitized signature HTML
        ...
        {showSchedule === true && (
          <ScheduleSendDialog
            // biome-ignore lint/nursery/useExplicitType: inline callback
            onSchedule={(ts) => void handleSchedule(ts)}
