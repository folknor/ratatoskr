...
- [Labels (Color Flags)](research-provider-label-colors.md) - ✅ Backend complete. Missing: label picker UI, apply/remove from UI. See `docs/glossary/folders-labels.md`.
