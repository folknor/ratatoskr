...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            calendar_commands::caldav_update_event,
            calendar_commands::caldav_delete_event,
            calendar_commands::caldav_sync_events,
            calendar_commands::caldav_test_connection,
