...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            db::queries_extra::db_create_contact_group,
            db::queries_extra::db_update_contact_group,
            db::queries_extra::db_delete_contact_group,
            db::queries_extra::db_get_all_contact_groups,
            db::queries_extra::db_get_contact_group,
            db::queries_extra::db_get_contact_group_members,
            db::queries_extra::db_add_contact_group_member,
            db::queries_extra::db_remove_contact_group_member,
            db::queries_extra::db_search_contact_groups,
            db::queries_extra::db_expand_contact_group,
            ...
            calendar_commands::commands::calendar_upsert_discovered_calendars,
            calendar_commands::commands::calendar_upsert_provider_events,
            calendar_commands::commands::calendar_apply_sync_result,
            calendar_commands::commands::calendar_sync_account,
            calendar_commands::commands::caldav_fetch_events,
            calendar_commands::commands::caldav_list_calendars,
            calendar_commands::commands::caldav_create_event,
            calendar_commands::commands::caldav_update_event,
            calendar_commands::commands::caldav_delete_event,
            calendar_commands::commands::caldav_sync_events,
            calendar_commands::commands::caldav_test_connection,
            calendar_commands::commands::calendar_delete_provider_event,
            calendar_commands::commands::google_calendar_create_event,
            calendar_commands::commands::google_calendar_delete_event,
            calendar_commands::commands::google_calendar_fetch_events,
            calendar_commands::commands::google_calendar_list_calendars,
            calendar_commands::commands::google_calendar_sync_events,
            calendar_commands::commands::google_calendar_update_event,
